import { AiFillHeart, AiOutlineHeart, AiOutlineMessage, AiOutlineShoppingCart, } from '../../Assests/icons/icons';
          ...
          <div className="w-full py-5">
            <div className="block w-full 800px:flex">
              <div className="w-full 800px:w-[50%]">
                ...
                {/* <img src="https://media.istockphoto.com/id/1458698228/photo/selective-focus-wood-table-top-on-blur-kitchen-counter-background.webp?b=1&s=170667a&w=0&k=20&c=gFqmi0u-oKGWor8ijZaX_1_gv78cHoeBJ1Lvpd6PGXQ=" alt="" className="w-[80%]" /> */}
                <div className="w-full flex">
                  {data && data.images.map((i, index) => (
                    <div className={`${select === 0 ? "border" : "null"} cursor-pointer`}>
                      <img src={`${backend_url}${i}`} alt="" className="h-[200px] overflow-hidden mr-3 mt-3" onClick={() => setSelect(index)} />
                      {/* <img src="https://media.istockphoto.com/id/1458698228/photo/selective-focus-wood-table-top-on-blur-kitchen-counter-background.webp?b=1&s=170667a&w=0&k=20&c=gFqmi0u-oKGWor8ijZaX_1_gv78cHoeBJ1Lvpd6PGXQ=" alt="" className="h-[200px] overflow-hidden mr-3 mt-3" onClick={() => setSelect(index)} /> */}
                    </div>
                  ))}
              ...
              <div className="w-full 800px:w-[50%] pt-5">
                ...
                <div className="flex items-center pt-8">
                  <Link to={`/shop/preview/${data?.shop._id}`}> <img src={`${backend_url}${data?.shop?.avatar}`} alt="" className="w-[50px] h-[50px] rounded-full mr-2" /> </Link>
                  <div className="pr-8">
                    <Link to={`/shop/preview/${data?.shop._id}`}> <h3 className={`${styles.shop_name} pb-1 pt-1`}> {data.shop.name} </h3> </Link>
