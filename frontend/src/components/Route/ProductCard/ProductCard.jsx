  ...
  return (
    <>
      <div className="item">
        ...
        <NavLink to={`${isEvent === true ? `/product/${data._id}?isEvent=true` : `/product/${data._id}`}`}>
        ...
        <div className="shopInfo">
          <div className="shopName">
            <NavLink to={`/shop/preview/${data?.shop._id}`}><h5>{data.shop.name}</h5></NavLink>
            <div>Units Available : <span style={{ 'color': "green" }}>10</span></div>
          </div>
